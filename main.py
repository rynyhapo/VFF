...
# Config 
class Config(object):
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7072130275:AAFQc1FGTaJdu0gQyYBZlgeJ7Qf3lIfVqkI")
    ...
    GROUPS = os.environ.get('GROUPS', '-1002023016154').split(',')
    for i in range(len(GROUPS)):
        GROUPS[i] = int(GROUPS[i])

    LOG_CH = os.environ.get("LOG_CH", "-1002023016154")
